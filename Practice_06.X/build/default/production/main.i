...
uint32_t new_num,curr_num = 0x10101010;
...
void main(void){
    ...
    while(1){
        while ((~PORTB & 0x0F) != 0){
            key_scanner();
            curr_num = curr_num << 8;
            curr_num = curr_num + new_num;
            _delay((unsigned long)((500)*(8000000/4000.0)));
        }
        send_to_disp(curr_num);
    }
}
...
void key_scanner(){
    LATB = 0xE0;
    switch (PORTB){
        case 0xEE: new_num = kbdMatrix[0][0]; break;
        case 0xED: new_num = kbdMatrix[0][1]; break;
        case 0xEB: new_num = kbdMatrix[0][2]; break;
        case 0xE7: new_num = kbdMatrix[0][3]; break;
    }
    LATB = 0xD0;
    switch (PORTB){
        case 0xDE: new_num = kbdMatrix[1][0]; break;
        case 0xDD: new_num = kbdMatrix[1][1]; break;
        case 0xDB: new_num = kbdMatrix[1][2]; break;
        case 0xD7: new_num = kbdMatrix[1][3]; break;
    }
    LATB = 0xB0;
    switch (PORTB){
        case 0xBE: new_num = kbdMatrix[2][0]; break;
        case 0xBD: new_num = kbdMatrix[2][1]; break;
        case 0xBB: new_num = kbdMatrix[2][2]; break;
        case 0xB7: new_num = kbdMatrix[2][3]; break;
    }
    LATB = 0x70;
    switch (PORTB){
        case 0x7E: new_num = kbdMatrix[3][0]; break;
        case 0x7D: new_num = kbdMatrix[3][1]; break;
        case 0x7B: new_num = kbdMatrix[3][2]; break;
        case 0x77: new_num = kbdMatrix[3][3]; break;
    }
    LATB = 0x00;
}
