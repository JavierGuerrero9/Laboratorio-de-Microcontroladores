...
# 1 "./LCD_disp_Driver.h" 1
# 66 "./LCD_disp_Driver.h"
void LCD_init(void);
void LCD_cmd (char);
...
void disp_Error(int numb){
    LCD_cmd(0b00000001);
    switch(numb){
    case 0: write_string_LCD("-Math Error"); break;
    case 1: write_string_LCD("-Math Error"); break;
    default: write_string_LCD("-Math Error"); break;
    }
}
